...
unsigned char *KaranRtn( unsigned char *TempIndx ) {
	...
	static unsigned char *MoreMarLoreLingTable5[] = {
		"ปาล์ม", "โฮล์ม", "บาล์ม", "ฟิล์ม"
	};
	static unsigned char *KoreKwaiLoreLingTable5[] = {
		"ชอร์ค", "ทอล์ค", "วอล์ค", "โฟล์ค"
	};
